...
//     fecha: '',
//     tipo_gasto: '',
//     otros_tipo_gasto: '', // Nuevo campo para tipo personalizado
//     valor: '',
//     se_factura: false,
...
//   // Handler para ver detalles del servicio (ya no hace petición)
//   const handleViewServicioFromFlete = useCallback(() => {
//     if (!fleteSeleccionado?.servicio) {
...
//       // Limpiar campo "otros_tipo_gasto" si se selecciona un tipo diferente a "Otros"
//       if (field === 'tipo_gasto' && value !== 'Otros') {
//         newForm.otros_tipo_gasto = '';
//       }
...
//         ? gastoForm.otros_tipo_gasto.trim()
...
//       if (gastoForm.tipo_gasto === 'Otros' && !gastoForm.otros_tipo_gasto.trim()) {
...
//         tipo_gasto: tipoGastoFinal, // Usar el tipo final
...
//             : modalMode === 'servicio'
//             ? `Detalles del Servicio - ${fleteSeleccionado?.servicio?.codigo_servicio_principal || fleteSeleccionado?.codigo_servicio || ''}`
...
//           )
//         ) : modalMode === 'servicio' ? (
//           // Vista de detalles del servicio (ya no hace petición)
...
//                         fleteSeleccionado.servicio.estado === 'Completado' 
//                           ? 'bg-green-100 text-green-800 border border-green-300'
//                           : fleteSeleccionado.servicio.estado === 'Cancelado'
//                           ? 'bg-red-100 text-red-800 border border-red-300'
//                           : 'bg-yellow-100 text-yellow-800 border border-yellow-300'
//                       }`}>
//                         {fleteSeleccionado.servicio.estado || 'Estado no disponible'}
//                       </span>
//                     </div>
//                     <div>
//                       <label className="block text-sm font-medium text-gray-500 mb-1">Fecha Servicio</label>
//                       <p className="text-sm text-gray-900">
//                         {formatFecha(fleteSeleccionado.servicio.fecha_servicio) || 'Fecha no disponible'}
//                       </p>
//                     </div>
//                     <div>
//                       <label className="block text-sm font-medium text-gray-500 mb-1">Tipo de Servicio</label>
//                       <p className="text-sm text-gray-900">
//                         {fleteSeleccionado.servicio.tipo_servicio || 'Tipo no disponible'} - 
//                         {fleteSeleccionado.servicio.modalidad_servicio || 'Modalidad no disponible'}
//                       </p>
//                     </div>
//                     <div>
//                       <label className="block text-sm font-medium text-gray-500 mb-1">Cliente</label>
//                       <p className="text-sm text-gray-900">
//                         {fleteSeleccionado.servicio.cliente?.nombre || 'Cliente no disponible'}
//                       </p>
//                     </div>
...
//                       <p className="text-sm text-gray-900">
//                         {fleteSeleccionado.servicio.origen || 'Origen no disponible'}
//                       </p>
//                     </div>
//                     <div>
//                       <label className="block text-sm font-medium text-gray-500 mb-1">Destino</label>
//                       <p className="text-sm text-gray-900">
//                         {fleteSeleccionado.servicio.destino || 'Destino no disponible'}
//                       </p>
//                     </div>
//                     {fleteSeleccionado.servicio.descripcion && (
//                       <div className="md:col-span-2">
//                         <label className="block text-sm font-medium text-gray-500 mb-1">Descripción</label>
//                         <p className="text-sm text-gray-900">{fleteSeleccionado.servicio.descripcion}</p>
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//                 className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm mb-2"
//                 required
//               >
...
//               {/* Campo para tipo personalizado cuando se selecciona "Otros" */}
...
//                   <input
//                     type="text"
//                     value={gastoForm.otros_tipo_gasto}
//                     onChange={(e) => handleGastoFormChange('otros_tipo_gasto', e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
//                     placeholder="Ej: Reparación de neumáticos, Mantenimiento, etc."
//                     required
//                   />
//                 </div>
//               )}
...
//               size="small"
//               icon={Save}
//               disabled={gastoForm.tipo_gasto === 'Otros' && !gastoForm.otros_tipo_gasto.trim()}
//             >
//               Guardar Gasto
//             </Button>
//           </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <p className="text-sm font-semibold text-gray-900">
                          {fleteSeleccionado.servicio?.codigo_servicio_principal || 'N/A'}
                        </p>
                      </div>
                      <div>
