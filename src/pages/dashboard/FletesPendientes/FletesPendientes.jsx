...
const FletesPendientes = ({ servicioId, servicioCodigo }) => {
  ...
  const handleApplyFilters = useCallback(() => {
    ...
    // Actualizar los filtros activos y ejecutar la búsqueda
  ...
  // Actualizar clearFilters para limpiar ambos
  const clearFilters = useCallback(() => {
    setLocalFilters({
      cliente: "",
      codigo_flete: "",
  ...
  // Actualizar la función handleFilterChange para usar localFilters
            ...
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    ¿Estás seguro de que deseas eliminar el flete{" "}
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    ...
                    asociado a este flete será cambiado automáticamente a estado{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <li>
                    • Monto: S/.{" "}
                    {parseFloat(fleteToDelete.monto_flete).toFixed(2)}
                  </li>
                  <li>• Estado actual: {fleteToDelete.estado_flete}</li>
                </ul>
              </div>
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <li>• Destino: {fleteToDelete.servicio?.destino || "N/A"}</li>
                  <li>
                    • Estado actual: {fleteToDelete.servicio?.estado || "N/A"}
                  </li>
                  <li>
                    • Nuevo estado:{" "}
