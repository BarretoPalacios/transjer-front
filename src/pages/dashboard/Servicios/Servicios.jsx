...
const Servicios = () => {
  ...
  const fetchServicios = useCallback(async () => {
    ...
    try {
      ...
      // Añadir paginación
      filtersForAPI.page = currentPage;
      filtersForAPI.page_size = 10;
      
      const response = await serviciosPrincipalesAPI.getAllServiciosPrincipales(filtersForAPI);
      
      // Si la respuesta tiene la estructura con data y pagination
  ...
  const handleCambiarEstado = useCallback(async () => {
    ...
    try {
      ...
      setError(`✅ Servicio actualizado exitosamente a ${estadoSeleccionado}`);
  ...
  }, [estadoSeleccionado, justificacion, servicioSeleccionado, usuarioActual, fetchServicios]);
  ...
  if (isLoading && serviciosData.data.length === 0) {
    return (
  ...
  const serviciosToShow = serviciosData.data;
  const pagination = serviciosData.pagination;
    ...
    <div className="">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Total: {pagination.total} servicios
          </p>
        </div>
      ...
      {error && (
        <div className={`mb-6 p-4 rounded-lg flex items-center justify-between ${
          error.includes('✅') ? 'bg-green-50 border border-green-200 text-green-700' : 'bg-red-50 border border-red-200 text-red-700'
        }`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFilters({...filters, cliente_nombre: e.target.value})}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFilters({...filters, flota_placa: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFilters({...filters, fecha_servicio: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFilters({...filters, proveedor_nombre: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFilters({...filters, cuenta_nombre: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFilters({...filters, gia_rr: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFilters({...filters, gia_rt: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
      ...
      <div className="bg-white border border-gray-300 shadow-sm rounded-sm overflow-hidden">
        ...
        {/* Sin resultados */}
        {serviciosToShow.length === 0 && !isLoading && (
      ...
      {serviciosToShow.length > 0 && (
        <div className="mt-4 flex justify-between items-center">
          <div className="text-sm text-gray-600">
            Mostrando {((currentPage - 1) * pagination.page_size + 1)} a {Math.min(currentPage * pagination.page_size, pagination.total)} de {pagination.total} registros
          </div>
          <div className="flex items-center space-x-2">
            <button
        ...
        {servicioSeleccionado && (
          <div className="space-y-6">
            ...
            {/* <div className="text-xs text-gray-500 italic pt-2 border-t border-gray-200">
              <p>⚠️ Nota: Este cambio de estado será registrado en el historial del servicio y no se puede deshacer automáticamente.</p>
            </div> */}
          </div>
        )}
      </Modal>
