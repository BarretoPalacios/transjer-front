...
//                 <span className="text-sm text-gray-600">Facturado Bruto</span>
//                 <span className="text-sm font-semibold">S/ {montoTotal.toFixed(2)}</span>
//               </div>
//               <div className="flex justify-between items-center">
//                 <span className="text-sm text-gray-600">Facturado bruto con Detraccion</span>
//                 <span className="text-sm font-semibold text-green-600">
//                   S/ {parseFloat(gestion.monto_neto || 0).toFixed(2)}
//                 </span>
//               </div>
//               <div className="flex justify-between items-center">
//                 <span className="text-sm text-gray-600">Monto de Detracción</span>
...
//                 <span className="text-sm font-medium text-gray-900">Adeuda</span>
...
//     </div>
//     <p className="text-xs text-gray-400 mt-2">Monto pendiente vencido</p>
//   </div>
// </div>
...
//     </div>
//     {/* <p className="text-xs text-gray-400 mt-2">Número total de Facturas</p> */}
//   </div>
...
//                        Fecha Emision: {formatearFecha(gestion.datos_completos?.fecha_emision || "-")}
//                       </div>
//                       <div className="text-xs text-gray-500">
//                        Fecha Vencimiento: {formatearFecha(gestion.datos_completos?.fecha_vencimiento || "-")}
//                       </div>
//                     </td>
...
//                             {gestion.fecha_probable_pago ? formatearFecha(String(gestion.fecha_probable_pago)) : "Sin fecha Asignada"}
//                           </div>
...
//   prioridad: "",
//   nombre_cliente: "",
//   nombre_proveedor: "", // NUEVO
//   numero_factura: "", // NUEVO
//   fecha_emision_inicio: "", // NUEVO
//   fecha_emision_fin: "", // NUEVO
//   fecha_vencimiento_inicio: "", // NUEVO
//   fecha_vencimiento_fin: "", // NUEVO
//   estado_detraccion: "", // NUEVO
// });
...
//   estadosPago: [
//     "Pendiente", "Programado", "Pagado Parcial", 
//     "Pagado", "Vencido", "En Disputa", "Anulado"
//   ],
//   estadosDetraccion: ["No Aplica", "Pendiente", "Pagado"],
//   proveedores: [],
//   clientes: [],
...
//     setFilters({ ...filters, nombre_cliente: "" });
//   } else {
//     setShowClienteCustomInput(false);
//     setClienteCustomValue("");
//     setFilters({ ...filters, nombre_cliente: value });
//   }
// };
...
//     setFilters({ ...filters, nombre_proveedor: "" });
//   } else {
//     setShowProveedorCustomInput(false);
//     setProveedorCustomValue("");
//     setFilters({ ...filters, nombre_proveedor: value });
//   }
// };
...
//           <button
//             onClick={() =>
//               setFilters({ ...filters, numero_factura: "" })
//             }
//             className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600"
//             disabled={isLoading}
//           >
...
//             </span>
//           )}
//           {appliedFilters.prioridad && (
//             <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
//               <AlertTriangle className="h-3 w-3 mr-1" />
//               Prioridad: {appliedFilters.prioridad}
//             </span>
//           )}
...
<div className="mb-6 bg-white rounded-lg border border-gray-300 shadow-sm p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <select
              value={filters.nombre_proveedor}
              onChange={(e) => setFilters({ ...filters, nombre_proveedor: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
            ...
            <div className="space-y-2">
              ...
              >
                <option value="">Todos los estados</option>
                {Object.values(EstadoPagoNeto).map((estado) => (
                  <option key={estado} value={estado}>
                    {estado}
                  </option>
                ))}
            ...
            <div className="space-y-2">
              ...
              >
                <option value="">Todos los estados</option>
                {Object.values(EstadoDetraccion).map((estado) => (
                  <option key={estado} value={estado}>
                    {estado}
                  </option>
                ))}
