...
import { Upload, Download, AlertCircle, X, FileSpreadsheet, CheckCircle, User } from 'lucide-react';
...
const ImportModal = ({
  ...
  const handleDownloadTemplate = useCallback(async () => {
    try {
      const blob = await personalAPI.downloadPlantillaExcel();
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      const result = await personalAPI.importPersonalExcel(selectedFile);
  ...
  const handleReset = () => {
    ...
    setError(null);
    setStep(1);
    if (document.getElementById('file-input-personal')) {
      document.getElementById('file-input-personal').value = '';
    }
  };
          ...
          <>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-700 space-y-1">
                    ...
                    <li>• <strong>Columnas obligatorias:</strong> DNI, Nombres Completos, Tipo</li>
                    <li>• DNI debe contener solo números (8-15 dígitos)</li>
                    <li>• Tipo debe ser: Conductor, Auxiliar, Operario, Administrativo, Supervisor, Mecánico, Almacenero</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-medium text-yellow-800 mb-1">Validaciones importantes:</h3>
                  <ul className="text-sm text-yellow-700 space-y-1">
                    <li>• <strong>Para conductores:</strong> Deben incluir Licencia de Conducir, Categoría y Fecha de Vencimiento</li>
                    <li>• Las fechas deben estar en formato YYYY-MM-DD</li>
                    <li>• El salario debe ser un número (puede incluir decimales)</li>
                    <li>• No se duplicarán registros con el mismo DNI</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-4 text-center">
                Descarga la plantilla de Excel para asegurar el formato correcto del personal
              </p>
              <Button
              ...
              <div className="w-full">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Button
                    type="button"
                    onClick={() => document.getElementById('file-input-personal').click()}
                    variant="secondary"
                    icon={Upload}
                    disabled={isLoading}
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="bg-white border border-gray-200 rounded-lg p-3 text-center">
                ...
                <div className="text-xs text-gray-600">Total filas procesadas</div>
              </div>
              <div className="bg-white border border-gray-200 rounded-lg p-3 text-center">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-3 text-center">
                ...
                <div className="text-xs text-gray-600">Registros actualizados</div>
              </div>
              <div className="bg-white border border-gray-200 rounded-lg p-3 text-center">
            ...
            {importResult.result?.errors && importResult.result.errors.length > 0 && (
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
                  <h4 className="font-medium text-gray-700">Errores encontrados ({importResult.result.errors.length}):</h4>
                  <p className="text-xs text-gray-600 mt-1">
                    Corrige estos errores y vuelve a importar el archivo
                  </p>
                </div>
            ...
            {importResult.result?.errors && importResult.result.errors.length > 0 && (
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <h4 className="font-medium text-gray-700 mb-2">Tipos de errores comunes:</h4>
                <ul className="text-sm text-gray-600 space-y-1">
                  {importResult.result.errors.some(e => e.includes('DNI')) && (
                    <li>• <strong>DNI:</strong> Debe contener solo números (8-15 dígitos)</li>
                  )}
                  {importResult.result.errors.some(e => e.includes('Tipo')) && (
                    <li>• <strong>Tipo de personal:</strong> Debe ser: Conductor, Auxiliar, Operario, Administrativo, Supervisor, Mecánico, Almacenero</li>
                  )}
                  {importResult.result.errors.some(e => e.includes('Licencia') || e.includes('Conductor')) && (
                    <li>• <strong>Para conductores:</strong> Deben incluir Licencia, Categoría y Fecha de vencimiento</li>
                  )}
                  {importResult.result.errors.some(e => e.includes('duplicado') || e.includes('ya existe')) && (
                    <li>• <strong>Duplicados:</strong> Los DNI duplicados serán omitidos</li>
                  )}
                </ul>
              </div>
            )}
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      {importResult.result?.created > 0 && `${importResult.result.created} registros creados `}
                      {importResult.result?.updated > 0 && `${importResult.result.updated} registros actualizados `}
                      {importResult.result?.skipped > 0 && `${importResult.result.skipped} registros omitidos `}
                      <br />
